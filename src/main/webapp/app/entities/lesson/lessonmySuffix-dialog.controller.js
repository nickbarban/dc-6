(function() {
    ...
    LessonMySuffixDialogController.$inject = ['$timeout', '$scope', '$stateParams', '$uibModalInstance', 'entity', 'Lesson'];

    function LessonMySuffixDialogController ($timeout, $scope, $stateParams, $uibModalInstance, entity, Lesson) {
        var vm = this;
